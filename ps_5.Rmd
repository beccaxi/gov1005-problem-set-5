...
# First, I have to filter for the age group of people 18-30. 

eighteenthirty <- survey %>% 
  select(age, religion) %>% 
...
religion for the age group of people 18-30 (don’t include 30) is “`r `” . 
The first-ranked religion category for people 30 and older is “`r `”. Hint: 
